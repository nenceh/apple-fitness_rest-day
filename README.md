...
***As of September 2024, <span class="highlight">Apple publicly released iOS 18</span>, the newest update of Apple's operating system. Under iOS 18, the Apple Fitness application received a <span class="highlight">new design</span> that includes a feature to pause rings for a specified amount of time. <span class="highlight">This project was made using the previous iOS 17 version of Apple Fitness on the iPhone and the watchOS 10 version on the Apple Watch.</span> Check out <a href="https://support.apple.com/en-ca/guide/iphone/ipha5dddb411/18.0/ios/18.0" target="_blank">Apple's iPhone User Guide for Fitness</a>.***
